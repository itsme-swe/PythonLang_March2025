...
In python if we create one function with different parameters the last function shadowed other functions automatically, but in C++ and java we can create one function with different parametrs.  
